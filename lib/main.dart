              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    _buildDiscoveryCategoryCard('Smart Home & Security', Icons.security_outlined),
                    _buildDiscoveryCategoryCard('Medical & Health Equipment', Icons.health_and_safety_outlined),
                    _buildDiscoveryCategoryCard('Power & Energy Systems', Icons.solar_power_outlined),
                    _buildDiscoveryCategoryCard('Vehicles & Mobility', Icons.electric_car_outlined),
                    _buildDiscoveryCategoryCard('Furniture & Fixtures', Icons.weekend_outlined),
                    _buildDiscoveryCategoryCard('Building', Icons.apartment_outlined),
                  ],
                ),
                const SizedBox(height: 32),
